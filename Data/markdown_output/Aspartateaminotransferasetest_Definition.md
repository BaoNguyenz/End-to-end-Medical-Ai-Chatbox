# Aspartateaminotransferasetest Definition
...
AST is found in the heart, liver, skeletal muscle, kidney, pancreas, spleen, lung, red blood cells, and brain tissue. When disease or injury affects these tissues, the cells are destroyed and AST is released into the bloodstream. The amount of AST is directly 
...
Other disorders or diseases in which the AST determination can be valuable include acute 

pancreatitis, muscle disease, trauma, severe burn, and infectious mononucleosis. 
...
Normal ranges for the AST are laboratoryspecific, but can range from 3-45 units/L (units per liter). 
